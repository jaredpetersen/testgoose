...
describe('model-mock', () => {
  ...
  for (const modelQueryFunction of modelQueryFunctions) {
    describe(`${modelQueryFunction.name}()`, () => {
      it('throws an error when called with arguments that the tester did not specify', (done) => {
        ...
        // Create a Mongoose Model mock
        const MyMock = modelMock();
        MyMock[modelQueryFunction.name].withArgs('cucumber', 'lime').returns(errStub, null);
      ...
      it('returns a query mock', (done) => {
        ...
        // Can't use instanceof to test this because Query is essentially a duplicate of the the function that was
        // actually used to create the query object
        expect(Object.getPrototypeOf(query)).to.deep.equal(Query.prototype);
        done();
      });
      ...
      it('mocks the callback err without parameters', (done) => {
        ...
        // Create a Mongoose Model mock
        const MyMock = modelMock();
        MyMock[modelQueryFunction.name].withArgs().returns(errStub, null);
      ...
      it('mocks the callback data without parameters', (done) => {
        ...
        // Create a Mongoose Model mock
        const MyMock = modelMock();
        MyMock[modelQueryFunction.name].withArgs().returns(null, dataStub);
      ...
      it('mocks the callback data with parameters', (done) => {
        ...
        // Create a Mongoose Model mock
        const MyMock = modelMock();
        MyMock[modelQueryFunction.name].withArgs('cucumber', 'lime').returns(null, dataStub);
  ...
  describe('prototype.save()', () => {
    it('mocks the callback err without parameters', (done) => {
      ...
      // Create a Mongoose Model mock
      const MyMock = modelMock();
      MyMock.prototype.save.withArgs().returns(errStub, null);
    ...
    it('mocks the callback err with parameters', (done) => {
      ...
      const MyMock = modelMock();
      MyMock.prototype.save.withArgs({validateBeforeSave: true}, 'mint').returns(errStub, null);
    ...
    it('mocks the callback doc without parameters', (done) => {
      ...
      // Create a Mongoose Model mock
      const MyMock = modelMock();
      MyMock.prototype.save.withArgs().returns(null, docStub);
    ...
    it('mocks the callback doc with parameters', (done) => {
      ...
      // Create a Mongoose Model mock
      const MyMock = modelMock();
      MyMock.prototype.save.withArgs({validateBeforeSave: true}, 'mint').returns(null, docStub);
