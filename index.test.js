  ...
  describe('mock find', () => {
    describe('promise', () => {
      it('asdf', () => {
        ...
        MyMock.find.withArgs({name: 'A'}).where.withArgs({age: 49 }).returns(null, databaseData2);
        MyMock.find.withArgs({name: 'A'}).where.withArgs({age: 35 }).where.withArgs({age: 35 }).returns(null, databaseData);
